  ...
  return (
    <BootstrapNavbar collapseOnSelect expand="lg" className="navabar">
      ...
      <BootstrapNavbar.Collapse
        className="navbar_enalace_iconos"
        id="responsive-navbar-nav"
      >
        <Nav className="enlaces ">
          <Nav.Link className="enlace" href="/productos">
            Productos
          </Nav.Link>
          <Nav.Link className="enlace" href="/login">
            Login
          </Nav.Link>
          <Nav.Link className="enlace" href="/register">
            Registrarse
          </Nav.Link>
          <Nav.Link className="enlace" href="#soporte">
            Soporte
          </Nav.Link>
          <Nav.Link className="enlace" href="#nosotros">
            Nosotros
          </Nav.Link>
        </Nav>
        <Nav className="align-items-center">
          ...
          <Nav.Link
            className="iconos"
            as={NavLink}
            to="/src/components/CartContent/CartContent.jsx"
          >
